...
$('body').delegate('.addEmployee', 'mouseenter',function() {
  $(this).append('<img class= "remove" src="cross.jpeg"/>');
});

// mouseleave function and removing cancel image
$('body').delegate('.addEmployee', 'mouseleave',function() {
...
$('body').delegate('.addTodos', 'click' , function() {
...
$('body').delegate('#searchButton', 'click' , function() {
  for(var i=0;i< $('.addEmployee').length;i++){
    if($('#searchText').prop('value') == $('.addEmployee:eq('+i+')').attr('id')) {
